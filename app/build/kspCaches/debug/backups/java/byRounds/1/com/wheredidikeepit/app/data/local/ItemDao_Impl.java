...
public final class ItemDao_Impl implements ItemDao {
  ...
  private final SharedSQLiteStatement __preparedStmtOfMigrateLegacyItems;
  ...
  public ItemDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfItemEntity = new EntityInsertionAdapter<ItemEntity>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `items` (`id`,`name`,`photoPath`,`location`,`notes`,`profileId`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement,
        ...
        statement.bindString(6, entity.getProfileId());
    ...
    this.__updateAdapterOfItemEntity = new EntityDeletionOrUpdateAdapter<ItemEntity>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `items` SET `id` = ?,`name` = ?,`photoPath` = ?,`location` = ?,`notes` = ?,`profileId` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfMigrateLegacyItems = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
      public String createQuery() {
        final String _query = "UPDATE items SET profileId = ? WHERE profileId = 'Default' OR profileId = 'default'";
        return _query;
      }
    };
  }
  ...
  @Override
  public Object migrateLegacyItems(final String newProfileId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfMigrateLegacyItems.acquire();
        int _argIndex = 1;
        _stmt.bindString(_argIndex, newProfileId);
        try {
          __db.beginTransaction();
          try {
            _stmt.executeUpdateDelete();
          ...
          __preparedStmtOfMigrateLegacyItems.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public Flow<List<ItemEntity>> observeAllItems(final String profileId) {
    final String _sql = "SELECT * FROM items WHERE profileId = ? ORDER BY updatedAt DESC";
      ...
      public List<ItemEntity> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new ItemEntity(_tmpId,_tmpName,_tmpPhotoPath,_tmpLocation,_tmpNotes,_tmpProfileId,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<ItemEntity>> searchItems(final String profileId, final String query) {
    final String _sql = "\n"
            + "        SELECT * FROM items \n"
            + "        WHERE (profileId = ?) AND (\n"
            + "            ? = '' \n"
  ...
  @Override
  public Flow<ItemEntity> observeItemById(final long id) {
      ...
      public ItemEntity call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new ItemEntity(_tmpId,_tmpName,_tmpPhotoPath,_tmpLocation,_tmpNotes,_tmpProfileId,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
